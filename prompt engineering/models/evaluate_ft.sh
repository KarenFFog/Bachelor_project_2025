#!/bin/bash
#SBATCH --job-name=eval_ft
#SBATCH --output=eval_ft_%j.out
#SBATCH --error=eval_ft_%j.err
...
#echo "Evaluating ft model ${SUBSET}% subset (seed ${SEED})"

# Run Python evaluation script with argument
#python evaluate_ft.py $SUBSET $SEED
