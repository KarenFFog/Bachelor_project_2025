...
for prec in precisions:
    for prompt_id in prompt_ids:
        input_path = os.path.join(BASE_DIR, f"prompt engineering/results/experiment_1_R2/precision_{prec}/results_prompt_{prompt_id}.jsonl")
        output_path = os.path.join(BASE_DIR, f"prompt engineering/results/experiment_2/{output_mode}/precision_{prec}/predicted_labels_{prompt_id}.jsonl")
